...
import fitcLogo from '@/assets/fitc-logo.png';
      ...
      <div className="brands-container container mx-auto px-6">
            ...
            {services.map((service, index) => (
              <div
                ...
                onClick={() => {
                  ...
                  const route = routes[service.category as keyof typeof routes];
                  if (route) {
                    if (route.startsWith('#')) {
                      document.getElementById(route.substring(1))?.scrollIntoView({ behavior: 'smooth' });
                    } else {
        ...
        <div className="brands-showcase">
          ...
          <div className="text-center max-w-5xl mx-auto">
            <div className="mb-8">
              <h3 className="text-3xl font-bold mb-3 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Partner Brands</h3>
